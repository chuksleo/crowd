                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Donations</p>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Fund Raised</p>
                                                <span class="number">₦<?php echo $total_raised?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Campaigns</p>
                                                <span class="number"><?php echo $total_campaigns ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="content">
                                    <div class="head">
                                        <h5 class="mb-0">Most Visited Projects</h5>
                                        <p class="text-muted">Current year website visitor data</p>
                                    </div>
                                    <div class="canvas-wrapper">
                                        <table class="table no-margin bg-lighter-grey">
